...
class DC_chip_no_bridge(rai.Compo):
    ...
    def _make(self,
        ...
        if inverse_pads == False:
            ...
            invert_merge = Invert_layer_v2(outer_box,merge,reverse=False).proxy().map("pads")
...
class DC_chip(rai.Compo):
    ...
    def _make(self,
        ...
        if inverse_pads == True:
            ...
            inverse_pads = Invert_layer_v2(outer_box,pads,reverse=False).proxy()
...
class DC_chip_monolayer_bridge(rai.Compo):
    ...
    def _make(self,
        ...
        if inverse_pads == False:
            ...
            inverse_pads = Invert_layer_v2(outer_box,merge_w_label,reverse=False).proxy().map("pads")
