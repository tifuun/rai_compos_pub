"""
This is an unused file that contains some code that used to
be used for "reducing" unnecessary parts of a TL
-- e.g. three nodes that are colinear
"""

## we hope this becomes a part of raimad.helpers
